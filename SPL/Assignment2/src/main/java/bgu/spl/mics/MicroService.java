...
public abstract class MicroService implements Runnable { 
    ...
    private HashMap<Class <? extends Message>,Callback> messageCallback; // hashmap of msg to its callback
    ...
    public MicroService(String name) {
        ...
        m.register(this); // we assume all microservices will always be registered
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        messageCallback.put(type,callback);
    	m.subscribeBroadcast(type,this);
    }
    ...
    public final void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            try {
                Message mes = m.awaitMessage(this);
                messageCallback.get(mes.getClass()).call(mes);
